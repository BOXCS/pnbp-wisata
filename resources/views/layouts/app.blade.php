...
<head>
    ...
    <style>
        ...
        .fade-image:nth-child(2) { animation-delay: -8s; }
        .fade-image:nth-child(3) { animation-delay: -4s; }
        ...
        .culture-item:hover img { transform: scale(1.05); transition: transform 0.3s ease; }
        .package-card:hover { transform: scale(1.02); transition: transform 0.3s ease; }
        .facility-card:hover { background-color: #f3f4f6; transition: background-color 0.3s ease; }
        .products-item:hover { transform: rotate(2deg); transition: transform 0.3s ease; }
        .insta-image:hover { filter: brightness(1.1); transition: filter 0.3s ease; }
        ...
        #social .elfsight-app-7148802b-a989-44c0-bc48-4b53fbc340c2 {
            max-height: 700px; overflow-y: hidden;
        }
        ...
        .loader::after {
            inset: 8px; transform: rotate3d(90, 90, 0, 180deg);
            border-color: #FF3D00;
        }
        ...
        #app-loader {
            ...
            background: #0b0b0b; z-index: 9999;
        }
        [data-app] { visibility: hidden }
        .app-ready #app-loader { display: none }
        .app-ready [data-app] { visibility: visible }
    </style>
